 ...
 */
function liquidFillGaugeDefaultSettings(config) {
  return {
    minValue: 0, // The gauge minimum value.
    maxValue: 1440, // The gauge maximum value.
    ...
    waveAnimateTime: 800, // The amount of time in milliseconds for a full wave to enter the wave circle.
